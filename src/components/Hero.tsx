...
export function Hero() {
  return <section className="intro-section"><div className="page-shell grid gap-8 py-12 md:grid-cols-[1.2fr_1fr] md:items-end md:py-16">
    <div><p className="eyebrow text-clay">{siteContent.name}</p><h2 className="mt-5 max-w-xl font-display text-5xl leading-[1.04] tracking-[-0.04em] text-forest sm:text-6xl lg:text-7xl">{siteContent.heroTitle.opening}<br />{siteContent.heroTitle.closing} <em className="text-clay">{siteContent.heroTitle.emphasis}</em></h2></div>
