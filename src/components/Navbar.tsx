    ...
    <header className="sticky top-0 z-50 border-b border-forest/10 bg-cream/95 backdrop-blur-md">
      <div className="page-shell flex h-[5.25rem] items-center justify-between">
        ...
        <nav className="hidden items-center gap-7 lg:flex" aria-label="Primary navigation">
          ...
          <Link href="/get-involved#donate" className="button button-primary !px-5 !py-3">
            Donate
          </Link>
        </nav>
      ...
      >
        <div className="page-shell flex flex-col py-4">
          ...
          <Link href="/get-involved#donate" onClick={() => setOpen(false)} className="button button-primary mt-4 justify-center">
            Donate
          </Link>
        </div>
      </nav>
